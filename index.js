...
console.log("CHAMI-MD Session downloaded ✅")
})})}
...
console.log("Connecting CHAMI-MD...⏳️");
...
console.log('CHAMI-MD Is Installing...🔥 ')
...
console.log('CHAMI-MD connected to whatsapp ✅')

let up = `
╭⊱✫🔮 CHAMI-MD 🔮✫⊱╮
│✫➠ - *📂REPOSITORY NAME:* CHAMI-MD
│✫➠ - *📃DESCRIPTION:* ❁ᴡᴏʀʟᴅ ʙᴇsᴛ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ❁
│✫➠ - *🛡️OWNER:* ᴄʜᴀᴍᴏᴅ ʏᴀꜱʜᴍɪᴋᴀ+ 
│✫➠ - *🌐 URL:* https://github.com
╰━━━━━━━━━━━━━━━━━╯

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\nPREFIX: ${prefix}`;
conn.sendMessage(config.BOT_NUMBER + "@s.whatsapp.net", { image: { url: `https://raw.githubusercontent.com/Ubalasiya/Chamihelper/refs/heads/main/chami-md-main.jpg` }, caption: up })
...
app.get("/", (req, res) => {
res.send("hey I am alive, CHAMI-MD Is started✅");
});
